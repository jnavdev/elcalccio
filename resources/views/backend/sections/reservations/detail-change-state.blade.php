                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                <div class="form-group row">
                                    <label for="detail_reservation_state" class="col-sm-2 col-form-label">Estado</label>
                                    <div class="col-sm-10">
                                        <input type="hidden" name="detail_reservation_id" id="detail_reservation_id">
                                        <select name="detail_reservation_state" id="detail_reservation_state" class="form-control">
