                        ...
                        <form action="{{ route('movements.update', $movement) }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="date" id="date"
                                                ...
                                                value="{{ old('date', $movement->date->format('d-m-Y')) }}" autocomplete="off" placeholder="Ingrese fecha">
                                            @error('date')
                                                <span
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="amount" id="amount" value="{{ old('amount', chileanPeso($movement->amount)) }}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="concept_type" id="concept_type" class="form-control">
                                                <option value="Ingreso" {{ ($movement->concept->type == 'Ingreso') ? 'selected' : '' }}>Ingreso</option>
                                                <option value="Gasto" {{ ($movement->concept->type == 'Gasto') ? 'selected' : '' }}>Gasto</option>
                                            </select>
                                        </div>
                                    </div>

                                    <div class="col-sm-6">
                                        <div class="form-group" id="select_incomes" @if ($movement->concept->type == 'Gasto') style="display: none;" @endif>
                                            ...
                                            <select name="concept_id_income" id="concept_id_income"
                                                ...
                                                @foreach ($incomes as $income)
                                                    <option value="{{ $income->id }}" {{ ($movement->concept_id == $income->id) ? 'selected' : '' }}>{{ $income->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group" id="select_expenses" @if ($movement->concept->type == 'Ingreso') style="display: none;" @endif>
                                            ...
                                            <select name="concept_id_expense" id="concept_id_expense"
                                                ...
                                                @foreach ($expenses as $expense)
                                                    <option value="{{ $expense->id }}" {{ ($movement->concept_id == $expense->id) ? 'selected' : '' }}>{{ $expense->name }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="payment_type"
                                                id="payment_type_cash" value="cash" {{ ($movement->payment_method_id == 1) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="payment_type"
                                                id="payment_type_bank" value="bank" {{ ($movement->payment_method_id != 1) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-sm-6" id="div_payment_methods" @if ($movement->payment_method_id == 1) style="display: none;" @endif>
                                        <div class="form-group">
                                            ...
                                            <select name="payment_method_id" id="payment_method_id"
                                                ...
                                                @foreach ($paymentMethods as $paymentMethod)
                                                    <option value="{{ $paymentMethod->id }}" {{ ($movement->payment_method_id == $paymentMethod->id) ? 'selected' : '' }}>{{ $paymentMethod->bank }} -
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" rows="4" class="form-control @error('description') is-invalid @enderror">{{ old('description', $movement->description) }}</textarea>
                                            @error('description')
                                                <span class="error invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
