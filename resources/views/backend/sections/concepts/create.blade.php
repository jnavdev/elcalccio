                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Ingrese nombre del concepto">
                                            @error('name')
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select name="type" id="type" class="form-control @error('type') is-invalid @enderror">
                                                <option value="" {{ old('type') ? '' : 'selected' }}>Seleccione</option>
